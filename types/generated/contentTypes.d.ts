...
export interface ApiColorColor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'hex_code'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    available_qty: Schema.Attribute.Integer;
    ...
    isBestSelling: Schema.Attribute.Boolean;
    ...
    stock_status: Schema.Attribute.Enumeration<['IN STOCK', 'OUT OF STOCK']>;
...
export interface ApiSizeSize extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::size.size'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    size_value: Schema.Attribute.String;
    slug: Schema.Attribute.UID<'size_value'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
